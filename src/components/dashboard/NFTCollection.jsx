      ...
      <div className="space-y-6">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all ${
                  filterCategory === cat.id
                    ...
                    : 'bg-[#f5f1e8] text-[#6b7f75] hover:bg-[#427898] hover:text-white'
                }`}
              >
                {cat.icon} {cat.name}
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {displayNFTs.map((nft) => (
            ...
            >
              {/* NFT Image */}
              <div className="bg-gradient-to-br from-[#f5f1e8] to-[#faf7f0] h-48 flex items-center justify-center border-b-4 border-[#427898] overflow-hidden">
      ...
      {selectedNFT && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-2xl w-full shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b-2 border-[#427898] p-6 flex items-center justify-between">
            ...
            <div className="p-6 space-y-6">
              {/* NFT Image */}
              <div className="bg-gradient-to-br from-[#f5f1e8] to-[#faf7f0] rounded-2xl h-64 flex items-center justify-center border-4 border-[#427898] overflow-hidden">
              ...
              {/* NFT Info */}
              <div>
                <h4 className="text-2xl font-bold text-[#427898] mb-2">{selectedNFT.name}</h4>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {selectedNFT.benefits.map((benefit, index) => (
                    <li key={index} className="flex items-start gap-2 text-[#427898]">
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-[#427898] text-white rounded-lg font-medium hover:bg-[#427898] transition-all flex items-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {showShareModal && selectedNFT && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-lg w-full shadow-2xl">
            <div className="bg-[#427898] p-6 rounded-t-2xl">
            ...
            <div className="p-6 space-y-6">
              {/* NFT Preview */}
              <div className="bg-gradient-to-br from-[#f5f1e8] to-[#faf7f0] rounded-xl p-4 border-2 border-[#427898]">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-[#427898]">{selectedNFT.name}</h4>
                    <p className="text-sm text-[#427898]">{selectedNFT.rarity} • {selectedNFT.brand}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-[#427898] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#a56b8a] bg-white resize-none"
                  rows="4"
                  maxLength="500"
                />
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={handleShare}
                  disabled={sharing}
                  className="flex-1 px-4 py-3 bg-gradient-to-r from-[#427898] to-[#3b6b6f] text-white rounded-lg hover:shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {sharing ? (
                    <>
